...
SECRET_KEY = os.environ.get('SECRET_KEY', 'protection-for-auth-of-non-existing-users-and-non-existing-form-submission')
...
DATABASES = {'default': dj_database_url.config(default='sqlite:///ccbv.db')}
